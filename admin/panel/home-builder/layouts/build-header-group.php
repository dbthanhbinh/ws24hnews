<li id="listItem_<?php echo $i ?>" class="ui-state-default">
    ...
    <div class="widget-content">
        ...
        <label for="tie_home_cats[<?php echo $i ?>][subtitle]">
            <span>Box subtitle :</span>
            <input id="tie_home_cats[<?php echo $i ?>][subtitle]"
                name="tie_home_cats[<?php echo $i ?>][subtitle]"
                value="<?php if( !empty($cat['subtitle']) ) echo $cat['subtitle'] ?>"
                type="text"
            />
        </label>
