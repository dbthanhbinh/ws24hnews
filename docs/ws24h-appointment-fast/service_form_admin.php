...
if(isset($_POST['action']) && $_POST['action'] == 'add-service'){
    if(check_admin_referer('add-service', 'add-service')){
        $data=array(
        ...
        <div class="col-wrap">        
            <div class="form-wrap">
                ...
                <form method="post" class="validate">
                    ...
                    <?php wp_nonce_field('add-service', 'add-service'); ?>

                    <div class="form-field form-required term-name-wrap">
                        <label for="tag-name">Service name</label>
                ...
                <table class="wp-list-table widefat fixed striped table-view-list tags">
                    <thead>
                        <tr>
                            ...
                            <th scope="col" id="name" class="manage-column column-name column-primary sortable desc"><a href=""><span>Service Name</span>
