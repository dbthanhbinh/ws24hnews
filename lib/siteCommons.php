...
if ( ! function_exists( 'FastSpa_time_link' ) ) :
    /**
     * Gets a nicely formatted string for the published date.
     */
    function FastSpa_time_link() {
        ...
        return sprintf(
            ...
            __( '<span class="screen-reader-text">Posted on</span> %s', 'FastSpa' ),
            '<a href="' . esc_url( get_permalink() ) . '" rel="bookmark">' . $time_string . '</a>'
        );
    }
endif;

if ( ! function_exists( 'FastSpa_posted_on' ) ) :
    /**
     * Prints HTML with meta information for the current post-date/time and author.
     */
    function FastSpa_posted_on($show = true) {
        if (!$show)
            return '';
        ...
        echo '<div class="posted-on-box"><span class="posted-on">' . FastSpa_time_link() . '</span><span class="byline"> ' . $byline . '</span></div>';
    }
endif;
